...
<ul>
	...
	<li>숫자리터럴(EL):${12345+34567898}</li>
	<li>숫자리터럴(SPEL):<s:eval expression="12345+34567898"/> </li>
	<li>논리리터럴(EL):${true}</li>
	...
	<li>SPEL(SCOPE객체에 등록된 숫자변수(속성이름)):
		<s:eval expression="price0+price1/9*0.32"/>
	</li>
	<li>SPEL(SCOPE객체에 등록된 문자열변수(속성이름)):
		<s:eval expression="name0.replace('kim','sim')"/>
	</li>
