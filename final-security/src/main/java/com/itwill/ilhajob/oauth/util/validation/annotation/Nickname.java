package com.itwill.ilhajob.oauth.util.validation.annotation;
...
import com.itwill.ilhajob.oauth.util.validation.validator.UserNicknameValidator;


@Documented                                                                     //애노테이션 정보를 문서에 같이 보여줌
@Constraint(validatedBy = UserNicknameValidator.class)                              //하단 설명 참고
